export const CommonResource: ResourceConstant[] = ['energy', 'power', 'ops'];
export const Minerals: ResourceConstant[] = ['H', 'O', 'Z', 'K', 'L', 'U', 'X'];
export const MineralCompound: ResourceConstant[] = ['ZK', 'UL', 'G'];
export const T1Compound: ResourceConstant[] = ['UO', 'UH', 'ZH', 'ZO', 'KH', 'KO', 'LH', 'LO', 'GH', 'GO', 'OH'];
export const T2Compound: ResourceConstant[] = ['UH2O', 'UHO2', 'ZHO2', 'ZH2O', 'LHO2', 'LH2O', 'KHO2', 'KH2O', 'GH2O', 'GHO2'];
export const T3Compound: ResourceConstant[] = [
	'XUH2O',
	'XUHO2',
	'XZHO2',
	'XZH2O',
...
export const AllCompound: ResourceConstant[] = [...MineralCompound, ...T1Compound, ...T2Compound, ...T3Compound];
export const MineralBar: ResourceConstant[] = [
	'reductant',
	'oxidant',
	'zynthium_bar',
	'keanium_bar',
...
export const BaseCommodity: ResourceConstant[] = ['mist', 'biomass', 'metal', 'silicon'];
export const LowValueCommodity: ResourceConstant[] = ['composite', 'crystal', 'liquid', 'wire', 'cell', 'alloy', 'condensate'];
export const HighValueCommodity: ResourceConstant[] = [
	'switch',
	'transistor',
	'microchip',
	'circuit',
...
export const AllCommodity: ResourceConstant[] = [...BaseCommodity, ...LowValueCommodity, ...HighValueCommodity];
...
interface AutomarketData {
	[resourceType: string]: {
		...
		min?: number /*系统默认的最限价防止 0.001 无法收到商品*/;
...
export const AutomarketBuydata: AutomarketData = {
	...
	battery: { max: 130 },
	utrium_bar: { max: 100 },
	lemergium_bar: { max: 100 },
	zynthium_bar: { max: 100 },
	keanium_bar: { max: 100, min: 5 },
	ghodium_melt: { max: 100 },
	oxidant: { max: 100 },
	reductant: { max: 100, min: 2 },
	purifier: { max: 100 },
	power: { max: 1000 },
	XUH2O: { max: 1000 },
	XUHO2: { max: 1000 },
